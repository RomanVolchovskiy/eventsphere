  ...
  return (
    <div className="pt-16 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        {/* Розділ ще не підключений до БД — заклади нижче демонстраційні.
            Прибрати цей банер разом із хардкодом у quickServices/restaurants/flowers. */}
        <section>
          <div className="bg-[var(--gold)]/5 border border-[var(--gold)]/20 rounded-2xl p-4 mb-8 flex items-start gap-3">
            <span className="text-lg leading-none mt-0.5">🚧</span>
            <p className="text-sm text-white/90">
              Розділ у розробці — заклади й ціни нижче показані для прикладу і поки не
              приймають бронювань.{" "}
              <Link href="/catalog" className="text-[var(--gold)] hover:underline">
                Справжні виконавці — у каталозі
              </Link>
              .
            </p>
          </div>
