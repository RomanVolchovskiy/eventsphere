...
export default function Today() {
  return (
    <section className="af-section" id="daily">
      <div className="af-head">
        <span className="af-kicker">Щоденні послуги</span>
        <h2 className="af-h2">
          Що на сцені <span className="accent">сьогодні</span> у місті
        </h2>
        <p className="af-lead">
          Столик у ресторані, квіти, торт — те, що потрібно не на велике
          свято, а просто сьогодні.
        </p>
      </div>

      <div className="af-idx">
        <div className="af-idx-head">
          <span>№</span>
          <span>Дата</span>
          <span>Подія</span>
          <span className="h-place">Місце</span>
          <span style={{ textAlign: "right" }}>Вхід</span>
          <span className="h-tag" style={{ textAlign: "right" }}>
            Формат
          </span>
        </div>
        {ROWS.map((r) => (
          <div className="af-idx-row" key={r.idx}>
