      ...
      <MarqueeFrame>
        <div className="hero-inner">
          ...
          <p className="hero-sub">
            Від ранкової кави з квітами — до фейерверків над Дніпром. ЄСвято збирає всі ритуали радості в одне місце: 2 400+ виконавців, AI-підбір команди, конструктор події та живу карту свят України.
          </p>
